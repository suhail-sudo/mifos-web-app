...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    connect: {
        options: {
            ...
            hostname: 'localhost',
            livereload: 35729,
			open:'http://<%= connect.options.hostname %>:<%= connect.options.port %>?baseApiUrl=https://finsys'
        },
        livereload: {
            options: {
                base: [
    ...
    uglify: {
      ...
      prod: { //Mention modules where min.js is missing
        files: [{
          ...
          '<%= mifosx.dist %>/<%=mifosx.target%>/bower_components/isteven-angular-multiselect/isteven-multi-select.min.js'
          :['<%= mifosx.app %>/bower_components/isteven-angular-multiselect/isteven-multi-select.js'],
          '<%= mifosx.dist %>/<%=mifosx.target%>/bower_components/codemirror/lib/codemirror.js'
          :['<%= mifosx.app %>/bower_components/codemirror/lib/codemirror.js'],
    ...
    copy: {
      prod: {
        files: [{
          ...
          src: [
            ...
            'scripts/sweetalert/dist/sweetalert.min.js',
              'scripts/sweetalert2/dist/*.js',
            'scripts/validate/*.js',
            //'scripts/intl-tel-input-master/build/css/*.css',
            'scripts/intl-tel-input-master/build/js/*.js',
              'scripts/countries/nationalities.js'
        ...
        },
        {
          ...
          '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/validate/jaidsValidator.js':['<%= mifosx.app %>/scripts/validate/jaidsValidator.js'],
          '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/validate/jquery.validate.min.js':['<%= mifosx.app %>/scripts/validate/jquery.validate.min.js'],
          '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/sweetalert/dist/sweetalert.min.js':['<%= mifosx.app %>/scripts/sweetalert/dist/sweetalert.min.js'],
            '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/sweetalert2/dist/sweetalert2.all.min.js':['<%= mifosx.app %>/scripts/sweetalert2/dist/sweetalert2.all.min.js'],

          '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/intl-tel-input-master/build/js/intlTelInput.js':['<%= mifosx.app %>/scripts/intl-tel-input-master/build/js/intlTelInput.js'],
          '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/countries/nationalities.js':['<%= mifosx.app %>/scripts/countries/nationalities.js']
           // '<%= mifosx.dist %>/<%=mifosx.target%>/scripts/dataTables/datatables.min.js':['<%= mifosx.app %>/scripts/dataTables/datatables.min.js']

            //'<%= mifosx.dist %>/<%=mifosx.target%>/scripts/intl-tel-input-master/build/css/intlTelInput.css':['<%= mifosx.app %>/scripts/intl-tel-input-master/build/css/intlTelInput.css'],
        ...
        },
        {
          ...
          src: [
            ...
            'angular-utils-pagination/dirPagination.tpl.html', 'codemirror/lib/*.css','codemirror/theme/twilight.css',
            'isteven-angular-multiselect/*.css'
          ]
        }
        ]
      },
  ...
  //grunt.registerTask('prod', ['clean:dist', 'clean:server', 'copy:prod', 'copy:tests', 'concat', 'uglify:prod', 'devcode:dist', 'hashres','replace']);
