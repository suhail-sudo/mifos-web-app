(function (mifosX) {
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/createLineFacilityProduct', {
                templateUrl: 'views/products/create_line_facility_product.html'
            })
            .when('/editloanproduct/:id', {
                templateUrl: 'views/products/editloanproduct.html'
            })
            .when('/editLineFacilityProduct/:id', {
                templateUrl: 'views/products/editLineFacilityProduct.html'
            })
            ...
            .when('/newLineFacilityContract/:clientId', {
                templateUrl: 'views/loans/newLineFacilityContract.html'
            })
            .when('/viewLineFacilityContract/:id', {
                templateUrl: 'views/loans/previewLineFacilityContract.html'
            })
            .when('/facilityContract/:id/edit', {
                templateUrl: 'views/loans/editLineFacilityContract.html'
            })
            ...
            .when('/lineFacilityProducts', {
                templateUrl: 'views/products/line_facility_listing.html'
            })
            .when('/charges', {
            ...
            .when('/editoffice/:id', {
             ...
             .when('/officetypes', {
                templateUrl: 'views/organization/officetypes/officetypes.html'
            })
            .when('/createofficetype', {
                templateUrl: 'views/organization/officetypes/createofficetype.html'
            })
            .when('/viewofficetype/:id', {
                templateUrl: 'views/organization/officetypes/viewofficetype.html'
            })
            .when('/editofficetype/:id', {
                templateUrl: 'views/organization/officetypes/editofficetype.html'
            })
            .when('/tasks', {
            ...
            .when('/viewcurrency/:code', {
                templateUrl: 'views/organization/viewcurrency.html'
            })
            .when('/search/:query', {
            ...
            .when('/viewlineFacilityproduct/:id', {
                templateUrl: 'views/products/viewLinefacilityProduct.html'
            })
            .when('/usersetting', {
            ...
            .when("/viewsavingstransactionreceipt/:savingsId/:txnId", {
                templateUrl: 'views/savings/viewsavingstransactionreceipt.html'
            })
            .when('/groups', {
            ...
            .when('/transactionAuthorisation/:commandId', {
                templateUrl: 'views/system/transactionAuthorisation.html'
            })
            .when('/help', {
            ...
            .when('/updatesavingsproduct/:id', {
                templateUrl: 'views/savings/updatesavingsproduct.html'
            })
            .when('/tellers', {
            ...
            .when('/address/:entity/:id', {
                templateUrl: 'views/administration/AddressForm.html'
            })
            .when('/editAddress/:addrType/:addrId/:clientId', {
                templateUrl: 'views/administration/EditAddress.html'
            })
            .when('/editOfficeAddress/:addrType/:addrId/:officeId', {
                templateUrl: 'views/administration/editOfficeAddress.html'
            })
            .when('/smscampaigns', {
            ...
            .when('/viewchargeslabs/:chargeId', {
                templateUrl: 'views/products/viewchargeslabs.html'
            }) ///Witness - Charge Slabs New Screen
            .when('/viewchargeslabsTwo/:chargeId', {
                templateUrl: 'views/products/viewChargeSlabsTwo.html'
            })
            .when('/viewchargeexemption/:chargeId', {
                templateUrl: 'views/products/viewchargeexemption.html'
            })
            .when('/ruleconfig/:entity/:category/:categoryId',{
                templateUrl:'views/configurations/ruleconfig.html'
            }).when('/ruleconfig',{
                templateUrl:'views/configurations/ruleconfmaster.html'
            })
            .when('/consumelimits/:entityName',{
                templateUrl:'views/configurations/consumelimits.html'
            })
            .when('/agents', {
                templateUrl: 'views/clients/agents.html'
            })
            .when('/createagent', {
                templateUrl: 'views/clients/createagent.html'
            })
            .when('/viewagent', {
                templateUrl: 'views/clients/viewagent.html'
            })
            .when('/editagent/:id', {
                templateUrl: 'views/clients/editagent.html'
            })
            .when('/configurations/globalconfigroute/savingsproduct/:configId', {
                templateUrl: 'views/administration/clientdefaultsavingsproduct.html'
            })
            .when('/adddevice', {
                templateUrl: 'views/devices/adddevice.html'
            })
            .when('/viewdevice/:id', {
                templateUrl: 'views/devices/viewdevice.html'
            })
            .when('/device', {
                 templateUrl: 'views/devices/device.html'
             })
             .when('/editdevice/:id', {
                templateUrl: 'views/devices/editdevice.html'
            })
            .when('/kyccategory', {
                templateUrl: 'views/kyccategory/kyccategory.html'
            })
            .when('/addkyccategory', {
                templateUrl: 'views/kyccategory/createkyccategory.html'
            })
            .when('/viewkyccategory/:id', {
                templateUrl: 'views/kyccategory/viewkyccategory.html'
            })
            .when('/editkyccategory/:id', {
                templateUrl: 'views/kyccategory/editkyccategory.html'
            })
            .when('/rulemaker',{
                templateUrl:"views/configurations/rulemaker.html"
            })
            .when('/couriers', {
                 templateUrl: 'views/couriers/couriers.html'
             })
             .when('/viewcourier/:courierId', {
                 templateUrl: 'views/couriers/viewcourier.html'
             })
             .when('/editcourier/:courierId', {
                 templateUrl: 'views/couriers/editcourier.html'
             })
             .when('/addcourier', {
                 templateUrl: 'views/couriers/addcourier.html'
             })
             .when('/couriers/:courierId/viewcouriertransactions', {
                 templateUrl: 'views/couriers/viewcouriertransactions.html'
             })
             .when('/couriers/:courierId/viewsinglecouriertransaction/:id', {
                 templateUrl: 'views/couriers/viewsinglecouriertransaction.html'
             })
             .when('/couriers/:courierId/addcouriertransactions', {
                 templateUrl: 'views/couriers/addcouriertransactions.html'
             })
             .when('/vaults', {
                 templateUrl: 'views/vaults/vaults.html'
             })
             .when('/createvault', {
                 templateUrl: 'views/vaults/createvault.html'
             })
             .when('/viewvault/:id', {
                 templateUrl: 'views/vaults/viewvault.html'
             })
             .when('/editvault/:id', {
                 templateUrl: 'views/vaults/editvault.html'
             })
             .when('/vaulttellers', {
                 templateUrl: 'views/vaults/vaulttellers.html'
             })
             .when('/vaults/:id/vaulttransactions', {
                 templateUrl: 'views/vaults/vaulttransactions.html'
             })
             .when('/vaults/:vaultId/addvaulttransactions', {
                 templateUrl: 'views/vaults/addvaulttransaction.html'
             })
             .when('/vaults/:vaultId/viewsinglevaulttransaction/:id', {
                 templateUrl: 'views/vaults/viewsinglevaulttransaction.html'
             })
             .when('/vaults/:vaultId/sendcash', {
                 templateUrl: 'views/vaults/sendcash.html'
             })
             .when('/vaults/:vaultId/requestcash', {
                 templateUrl: 'views/vaults/requestcash.html'
             })
            .when('/cards', {
                templateUrl: 'views/Cards/cardProvisioning.html'
            })
            .when('/cardOpr', {
                templateUrl: 'views/Cards/clientCardManagement.html'
            })
            .when('/cardSettle', {
                templateUrl: 'views/Cards/cardSettlement.html'
            })
            .when('/cardOperations/:id', {
                templateUrl: 'views/Cards/cardOperations.html'
            })
            .when('/cardOperationsDetailedInfo/:id',{
                templateUrl: 'views/Cards/viewCardDetailedInfo.html'
            }).when('/cardOperations/withdrawFunds/:id',{
                templateUrl: 'views/Cards/withdrawFunds.html'
            })
            .when('/cardOperations/loadFunds/:id',{
                templateUrl: 'views/Cards/loadFunds.html'
            })
            .when('/cardOperations/postCharge/:id',{
                templateUrl: 'views/Cards/postCharge.html'
            })
            .when('/cardOperations/cardToCardTransfer/:id',{
                templateUrl: 'views/Cards/cardToCard.html'
            })
            .when('/profiles/profileToProfileTransfer',{
                templateUrl: 'views/Cards/profileToProfile.html'
            })
            .when('/profiles/mapProfileToGLAccount',{
                templateUrl: 'views/Cards/mapProfileToGL.html'
            })
            .otherwise({
