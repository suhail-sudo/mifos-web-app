(function () {
    require.config({
        ...
        paths: {
            ...
            'codemirror-css': '../bower_components/codemirror/lib/codemirror.css',
            'twilight-css': '../bower_components/codemirror/theme/twilight.css',
			...
			'isteven-multi-select': '../bower_components/isteven-angular-multiselect/isteven-multi-select',
            ...
            'sweetalert' : '../scripts/sweetalert/dist/sweetalert.min',
            'sweetalert2' : '../scripts/sweetalert2/dist/sweetalert2.all.min',
            'jaidsValidator':'../scripts/validate/jaidsValidator',
            'jquery-validate': '../scripts/validate/jquery.validate.min',

            //'intlTelInput': '../scripts/intl-tel-input-master/build/css/intlTelInput.css',
            'intlTelInput': '../scripts/intl-tel-input-master/build/js/intlTelInput',
            'countries': '../scripts/countries/nationalities'
            //'dataTables': '../scripts/dataTables/datatables.min'
        ...
        shim: {
            ...
            'codeMirror' :{deps: ['angular'], exports:'codeMirror'},
            'codeMirrorUi' :{deps: ['codeMirror']},
            'ngIdle': {deps: ['angular']},
            ...
            'isteven-multi-select': {deps: ['angular']},
            'mifosX': {
                deps: [
                    'angular',
                    'jquery',
