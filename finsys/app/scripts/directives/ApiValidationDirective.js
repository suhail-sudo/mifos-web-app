            ...
            return {
                ...
                link: function (scope, elm, attr, ctrl) {
                    var template = '<div uib-alert type="danger" ng-show="errorStatus || errorDetails.length > 0">' +
                        ...
                        '<span ng-if ="errorArray.args.params[0].value" >{{' + 'errorArray.args.params[0].value'    +' | translate}}' + ' field is required</span>' +
                        '<span ng-if ="!errorArray.args.params[0].value" > Error</span>'+
                        '</label>' +
