                    ...
                    if (treeId === "holidaytreeview") {
                        template =
                            '<ul>' +
                                ...
                                '</li>' +
                                '</ul>';
                    } else if(treeId === "paymenttypetreeview") {
                    	template =
                            '<ul>' +
                                '<div data-ng-show="' + treeId + '.showChangeStateAll(' + treeModel + ')">' +
                                '<a  data-ng-click="' + treeId + '.setCollapsedRoot(' + treeModel + ', false)">{{\'label.button.expand.all\' | translate}}</a>' +
                                ...
                                '<li data-ng-repeat="node in ' + treeModel + '">';
                        if(disabled)
                        	template += '<input ng-disabled="true" type="checkbox" data-ng-model="node.selectedCheckBox" data-ng-change="officeTypeApplyToPaymentType(node)"></input>';
                    	else
                    		template += '<input type="checkbox" data-ng-model="node.selectedCheckBox" data-ng-change="officeTypeApplyToPaymentType(node)"></input>';
                		template +=  '<i class="collapsed" data-ng-show="node.' + nodeChildren + '.length && node.collapsed" data-ng-click="' + treeId + '.selectNodeHead(node)"></i>' +
                                '<i class="expanded" data-ng-show="node.' + nodeChildren + '.length && !node.collapsed" data-ng-click="' + treeId + '.selectNodeHead(node)"></i>' +
                                '<i class="normal" data-ng-hide="node.' + nodeChildren + '.length"></i> ' +
                                '<span ng-show="node.'+ nodeId + ' >= 0" data-ng-class="node.selected" data-ng-click="' + treeId + '.selectNodeLabel(node); $root.tempNodeID = node.'+ nodeId +'">({{node.'+ nodeglCode +'}}) {{node.' + nodeLabel + '}} </span>' +								
								'<span ng-show="node.'+ nodeId + ' < 0" data-ng-class="node.selected" data-ng-click="' + treeId + '.selectNodeLabel(node)" >{{node.' + nodeLabel + '}}</span>' +
                                ...
                                '</li>' +
                                '</ul>';
                    } else if(treeId === "officestreeview") {
                    	template =
                            '<ul>' +
                                '<div data-ng-show="' + treeId + '.showChangeStateAll(' + treeModel + ')">' +
                                '<a  data-ng-click="' + treeId + '.setCollapsedRoot(' + treeModel + ', false)">{{\'label.button.expand.all\' | translate}}</a>' +
                                ...
                                '<li data-ng-repeat="node in ' + treeModel + '">';
                        if(disabled)
                        	template += '<input ng-disabled="true" type="checkbox" data-ng-model="node.selectedCheckBox" data-ng-change="officesTree(node)"></input>';
                    	else
                    		template += '<input type="checkbox" data-ng-model="node.selectedCheckBox" data-ng-change="officesTree(node)"></input>';
                		template +=  '<i class="collapsed" data-ng-show="node.' + nodeChildren + '.length && node.collapsed" data-ng-click="' + treeId + '.selectNodeHead(node)"></i>' +
                                '<i class="expanded" data-ng-show="node.' + nodeChildren + '.length && !node.collapsed" data-ng-click="' + treeId + '.selectNodeHead(node)"></i>' +
                                '<i class="normal" data-ng-hide="node.' + nodeChildren + '.length"></i> ' +
                                '<span ng-show="node.'+ nodeId + ' >= 0" data-ng-class="node.selected" data-ng-click="' + treeId + '.selectNodeLabel(node); $root.tempNodeID = node.'+ nodeId +'">({{node.'+ nodeglCode +'}}) {{node.' + nodeLabel + '}} </span>' +								
