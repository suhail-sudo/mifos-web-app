(function (module) {
    mifosX.controllers = _.extend(module, {
        CurrencyConfigController: function (scope, resourceFactory, location, route) {

            scope.selectedCurrOptions = [];
            scope.allCurrOptions = [];
            scope.hideview = false;
            scope.selected = undefined;
            scope.routeTo = function(code) {
            	location.path('/viewcurrency/' + code);
            }
    ...
    mifosX.ng.application.controller('CurrencyConfigController', ['$scope', 'ResourceFactory', '$location', '$route', mifosX.controllers.CurrencyConfigController]).run(function ($log) {
