(function (module) {
    mifosX.controllers = _.extend(module, {
    	ViewAgentController: function (scope, routeParams, route, location, resourceFactory, http, $uibModal, API_VERSION, $rootScope, Upload) {
            scope.client = [];
    ...
    mifosX.ng.application.controller('ViewAgentController', ['$scope', '$routeParams', '$route', '$location', 'ResourceFactory', '$http', '$uibModal', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.ViewAgentController]).run(function ($log) {
        $log.info("ViewAgentController initialized");
    });
}(mifosX.controllers || {}));
